...
<body>
    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12">
          ...
          <p class="lead">
            <i class="fas fa-map-marker"></i>${roomdetail.location}</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <nav>
        <ol class="breadcrumb">
         ...
         <!--   <li class="breadcrumb-item">
          ...
          <li class="breadcrumb-item active">${roomdetail.type}</li>
        </ol>
      </nav>
    </div>
  </section>
  ...
  <section id="roomDetail" class="py-4">
    <div class="container">
      <a href="${pageContext.request.contextPath}/user/home" class="btn btn-light mb-4">Back To Home</a>
      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <div class="row mb-5">
            <div class="col-md-12">
              These information are provided by room owner and they are as much as correct.
              If you have further inquiry then contact us.
            </div>
          </div>
