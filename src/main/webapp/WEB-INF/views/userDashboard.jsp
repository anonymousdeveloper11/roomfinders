    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p>Here are the booking details that you have booked</p>
          <table class="table">
            <thead>
            ...
            <c:forEach items="${bookinglist}" var="booking">
              <tr>
                ...
                <td>${booking.room.phone}</td>
                <td>${booking.room.usersDetails.name }</td>
                <td>
                  <a class="btn btn-light" href="${pageContext.request.contextPath}/bookingDetail/${booking.id}">View Room Detail</a>
                  <a class="btn-btn-light" href="${pageContext.request.contextPath}/user/book/delete/${booking.id}">Delete</a>
                </td>
              </tr>
              </c:forEach>
