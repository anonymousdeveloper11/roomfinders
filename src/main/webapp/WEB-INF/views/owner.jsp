  ...
  <section id="showcase-inner" class="py-5 text-white">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12">
          <h1 class="display-4">Owner Home</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p>Here your property details verified by admin</p>
          <table class="table">
            <thead>
              <tr>
                <th scope="col">id</th>
           ...
           <!-- <c:forEach items="${roomlist}" var="room">
              <tr>
                ...
                <td>${room.type}</td>
                <td>
                  <a class="btn btn-light" href="${pageContext.request.contextPath}/ownerRoomDetail">View Detail</a>
                </td>
              </tr>
              </c:forEach>
